...
#define HEAP_TINY_COMMIT_FLAGS 1 /* if commit flags use, */ 
#define HEAP_TINY_CHECKSUM_FLAGS 0 /* if checksum use */ 
...
#define HEAP_TINY_DELAYED_CACHE_FLUSH_FLAGS 0 /* flag for delayed cache flush */ 
...
#define HEAP_TINY_GLOBAL_COUNT_FLAGS 0 /* flag for global count */ 
